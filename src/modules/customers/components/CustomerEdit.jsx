        ...
        <Formik
          ...
          onSubmit={async (values) => {
            let profileDeployment =
              values.profile_deployment_v2 === null
                ? []
                : values.profile_deployment_v2.map((profile) => {
                    if (isNaN(profile)) {
            ...
            let profileMarketin =
              values.profile_marketing_v2 === null
                ? []
                : values.profile_marketing_v2.map((profile) => {
                    if (isNaN(profile)) {
                      return profile.value
                    }
                    return profile
            ...
            let profileProject =
              values.profile_project_manager_v2 === null
                ? []
                : values.profile_project_manager_v2.map((profile) => {
                    if (isNaN(profile)) {
                      return profile.value
                    }
                    return profile
          ...
          validationSchema={Yup.object({
            ...
            postal_code: Yup.string().max(5, "Maximum length 5"),
          })}
        >
              ...
              >
                ...
                <div className={form}>
                  <Form.Item label="Customer ID" required>
                    <FormikInput name="uuid" disabled className={item} />
                  </Form.Item>
                  <Form.Item label="Company">
                    <FormikInput name="company" className={item} />
                  </Form.Item>
                  ...
                  <Form.Item label="First Name" required>
                    <FormikInput name="name" className={item} />
                  </Form.Item>
                  <Form.Item label="Last Name" required>
                    <FormikInput name="last_name" className={item} />
                  </Form.Item>
                  <Form.Item label="Display Name as" required>
                    <Select
                      name="display_name_as"
                      options={
                        values.company === null || values.company === ""
                          ? optionsName
                          : [
                              ...optionsName,
                              {
                  ...
                  >
                    <FormikInput name="email_contact" className={item} />
                  </Form.Item>
                  <Form.Item label="Phone" required>
                    <FormikInput name="phone" className={item} />
                  </Form.Item>
                  <Form.Item label="Address">
                    <FormikInput name="street1" className={item} />
                  </Form.Item>
                  <Form.Item label="Address 2">
                    <FormikInput name="street2" className={item} />
                  </Form.Item>
                </div>
                <div className={form2}>
                  <Form.Item label="City">
                    <FormikInput name="city" className={item} />
                  </Form.Item>
                  <Form.Item
                ...
                <Typography.Title level={4}>Customer’s Team</Typography.Title>
                <Divider dashed />
                <div className={form2}>
