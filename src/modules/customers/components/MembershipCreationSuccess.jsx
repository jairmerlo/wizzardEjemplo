  ...
  return (
    <IDXCard style={{ width: "400px", height: "fit-content" }}>
      <IDXCardContent>
        ...
        <YourProductItem label={method} text={paymentMethodValue} />
        {/* Card: **********1111 */}
        <Typography.Title
          level={4}
          style={{ textAlign: "left", marginTop: 10 }}
        ...
        <YourProductItem label="Setup Fee ( One Time )" text={setupFee} />
        <Divider style={{ margin: "15px 0" }} />
        <YourProductItem label="Monthly Fee" text={monthlyFee} />
        <Divider style={{ margin: "15px 0" }} />
        ...
        {addOns.map((addOn) => (
          <>
            <YourProductItem label={addOn.name} text={addOn.amount} />
      ...
      >
        ...
        />
        <Divider style={{ margin: "15px 0" }} />
        <YourProductItem label="Billing Cycle Date" text={billingCycleDate} />
      </div>
      {couponId !== null && (
        <IDXCardContent>
          ...
          <YourProductItem label="Coupon Name:" text={couponName} />
          <YourProductItem
            label="Setup Fee"
            text={`${sign === "$" ? "$" : ""} ${setupfeeAmount} ${
              sign === "%" ? "%" : ""
            } ( Discount)`}
          />
          {monthlyfeeAmount > 1 && (
