...
import { Actions } from "../../memberships/components"
...
export const MembershipDetails = () => {
  ...
  if (hasPayments === 1) options.push("Add Payment Details")
    ...
    <div style={{ display: "flex", flexDirection: "column", gap: "32px" }}>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
        ...
        {section === "Launch Website" && (
          <LaunchWebsite registrationKey={membershipRegKey} />
        )}
        ...
        {(section === "IDX Request" || section === "IDX Request Approved") && (
          <IdxRequest registration_key={membershipRegKey} />
        )}
        {section === "Product Timeline" && (
          <ProductPurchasedTimeline registration_key={membershipRegKey} />
        )}
        {section === "Add Payment Details" && (
          <AddPayment registration_key={membershipRegKey} />
        )}
      </div>
