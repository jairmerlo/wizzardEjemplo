  ...
  return (
    ...
    >
      ...
      <div className="modalActions">
          ...
          content={
            <Space size="middle" direction="vertical">
              <Tooltip title="CPanel">
                <a
                  href={`https://backoffice.idxboost${window.MODE}/customers/memberships/login/cpanel/${currentId}`}
                  target="_blank"
                  rel="noreferrer"
              ...
              <Tooltip title="Wordpress">
                <a
                  href={`https://backoffice.idxboost${window.MODE}/customers/memberships/login/wordpress/${currentId}`}
                  target="_blank"
                  rel="noreferrer"
                  style={{ textDecoration: "none" }}
                >
                  ...
                  >
                    <span
                      className="back-office-wordpress"
                      style={{ fontSize: "20px" }}
                    ></span>
                    Wordpress
                  </div>
        ...
        >
          <Tooltip title="Login">
            <div className="itemButtonActions">
              <span
                className="back-office-key"
                style={{ fontSize: "20px" }}
              ></span>
              LOGIN
            </div>
        ...
        <Tooltip title="Accounting classifications" className="itemGridToolbox">
          <a
            href={`${window.location.origin}/accounting/memberships/accounting_classification/${currentId}`}
            target="_blank"
            rel="noreferrer"
            className="itemButtonActions"
          >
        ...
        {!billingCicle && (
          <BillingEnrollment
            registration_key={currentRegKey}
            userId={userId}
            billingEnrollment={billingEnrollment}
          />
        )}
        <AddPayment registration_key={currentRegKey} addPayment={addPayment} />
