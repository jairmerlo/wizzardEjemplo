...
import { Button, Divider, Modal, Typography, Upload, message, notification } from "antd"
import { useCss } from 'react-use'
import { UploadOutlined } from '@ant-design/icons'
import { useState } from 'react'
import TextArea from 'antd/es/input/TextArea'
import { useGetPlanByregistrationKeyV2Query, useGetProviderAccountQuery } from '../../../app/api/billing'
import { useAddPaymentMutation } from '../../../app/api/backoffice'

export const AddPaymentChild = ({ open = false, handleClose = f => f, registration_key = "" }) => {

    const { data: plans = [] } = useGetPlanByregistrationKeyV2Query({ registration_key })
    // console.log({ plans })
    ...
    const upLoadFile = async (file) => {
        ...
        try {
            ...
            const res = await fetch('https://api-billing.idxboost.dev/api/upload-file', {
                method: 'POST',
                body: formData
            }).then(res => res.json())
                    ...
                    <>
                        <div className={form2} >
                            ...
                            <Form.Item
                                label='Invoice#'
                                required
                                validateStatus={errors.invoiceNumber && touched.invoiceNumber && 'error'}
                        ...
                        <div className={form2}>
                            <Form.Item
                                label='Init'
                                required
                                validateStatus={errors.invoicePeriodInit && touched.invoicePeriodInit && 'error'}
                            ...
                            <Form.Item
                                label='End'
                                required
                                validateStatus={errors.invoicePeriodEnd && touched.invoicePeriodEnd && 'error'}
                        ...
                        <div className={form2}>
                            <Form.Item
                                ...
                                required
                                validateStatus={errors.sourcePayment && touched.sourcePayment && 'error'}
                            ...
                            <Form.Item
                                ...
                                required
                                validateStatus={errors.programName && touched.programName && 'error'}
                            ...
                            >
                                <Select
                                    ...
                                    options={plans}
                                    onChange={(value) => {
                                        const code = (plans.find(({ label }) => label === value))?.code || ""
                            ...
                            <Form.Item
                                label='Attach File'
                                validateStatus={errors.fileAttach && touched.fileAttach && 'error'}
